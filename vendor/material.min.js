            ...
            if (this.element_) {
                if (
                    ...
                    e.classList.add(this.CssClasses_.RIPPLE_CONTAINER),
                        ...
                        (this.boundRippleBlurHandler = this.blurHandler_.bind(
                            this
                        )),
            ...
            if (this.element_) {
                ...
                if (
                    ...
                    this.element_.classList.add(
                        ...
                        (this.rippleContainerElement_ = document.createElement(
                            'span'
                        )),
    ...
    (window.MaterialMenu = d),
        ...
        (d.prototype.init = function() {
            if (this.element_) {
                ...
                (this.boundItemKeydown_ = this.handleItemKeyboardEvent_.bind(
                    this
                )),
        ...
        (L.prototype.init = function() {
            if (
                ...
                this.input_.hasAttribute(this.Constant_.MAX_ROWS_ATTRIBUTE) &&
                    ...
                    (this.boundUpdateClassesHandler = this.updateClasses_.bind(
                        this
                    )),
                    (this.boundFocusHandler = this.onFocus_.bind(this)),
                    (this.boundBlurHandler = this.onBlur_.bind(this)),
                    ...
                    this.maxRows !== this.Constant_.NO_MAX_ROWS &&
                        ((this.boundKeyDownHandler = this.onKeyDown_.bind(
                            this
                        )),
                        this.input_.addEventListener(
                            'keydown',
            ...
            if (this.element_) {
                ...
                e && (this.forElement_ = document.getElementById(e)),
                    this.forElement_ &&
                        ...
                        (this.boundMouseEnterHandler = this.handleMouseEnter_.bind(
                            this
                        )),
